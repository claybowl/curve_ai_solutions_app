...
export default function FundraisingPage() {
  ...
  return (
    <main className="min-h-screen">
      ...
      <section className="py-12 bg-white dark:bg-gray-950">
        <div className="container px-4 md:px-6 mx-auto">
          <div className="max-w-4xl mx-auto">
            ...
            <Card className="border-2 border-[#0076FF] dark:border-blue-700 shadow-lg mb-8">
              <CardContent className="p-6">
                <div className="flex flex-col md:flex-row md:items-center justify-between mb-6">
                  <div>
                    <p className="text-sm text-gray-500 dark:text-gray-400 mb-1">Current Funding</p>
                  ...
                  <div className="mt-4 md:mt-0">
                    <span className="text-lg font-semibold text-[#0076FF] dark:text-blue-400">{percentFunded}% Funded</span>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-center">
                  <div className="p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                    <div className="flex items-center justify-center mb-2">
                      <Users className="h-5 w-5 text-[#0076FF] dark:text-blue-400 mr-2" />
                      <span className="font-semibold dark:text-gray-200">{campaignData.backers}</span>
                    </div>
                    <p className="text-sm text-gray-500 dark:text-gray-400">Backers</p>
                  </div>
                  <div className="p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                    <div className="flex items-center justify-center mb-2">
                      <Clock className="h-5 w-5 text-[#0076FF] dark:text-blue-400 mr-2" />
                      <span className="font-semibold dark:text-gray-200">{campaignData.daysLeft}</span>
                    </div>
                    <p className="text-sm text-gray-500 dark:text-gray-400">Days Left</p>
                  </div>
                  <div className="p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                    <div className="flex items-center justify-center mb-2">
                      <CalendarDays className="h-5 w-5 text-[#0076FF] dark:text-blue-400 mr-2" />
                      <span className="font-semibold dark:text-gray-200">{campaignData.endDate}</span>
                    </div>
            ...
            <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-6 mb-12">
              <h2 className="text-2xl font-bold text-[#1A365D] dark:text-blue-300 mb-4">Our Vision</h2>
              <p className="text-gray-700 dark:text-gray-300 mb-4">{campaignData.story}</p>
        ...
        <div className="container px-4 md:px-6 mx-auto">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-[#1A365D] dark:text-blue-300 mb-4">Funding Goals</h2>
              <p className="text-gray-600 dark:text-gray-400">Here's what we'll achieve with your support</p>
            </div>
            ...
            <div className="space-y-8">
              <div className="relative pl-8 sm:pl-32 py-6 group">
                <div className="flex flex-col sm:flex-row items-start mb-1 group-last:before:hidden before:absolute before:left-2 sm:before:left-12 before:h-full before:px-px before:bg-gray-300 dark:before:bg-gray-600 before:ml-0.5 before:top-6 before:bottom-0">
                  ...
                  <div className="font-caveat font-bold text-xl text-[#0076FF] dark:text-blue-400 w-24 hidden sm:block">$10,000</div>
                  <div>
                    <div className="sm:hidden font-caveat font-bold text-xl text-[#0076FF] dark:text-blue-400 mb-1">$10,000</div>
                    <div className="text-xl font-bold text-gray-900 dark:text-gray-100">Database Infrastructure</div>
              ...
              <div className="relative pl-8 sm:pl-32 py-6 group">
                <div className="flex flex-col sm:flex-row items-start mb-1 group-last:before:hidden before:absolute before:left-2 sm:before:left-12 before:h-full before:px-px before:bg-gray-300 dark:before:bg-gray-600 before:ml-0.5 before:top-6 before:bottom-0">
                  ...
                  <div className="font-caveat font-bold text-xl text-[#0076FF] dark:text-blue-400 w-24 hidden sm:block">$25,000</div>
                  <div>
                    <div className="sm:hidden font-caveat font-bold text-xl text-[#0076FF] dark:text-blue-400 mb-1">$25,000</div>
                    <div className="text-xl font-bold text-gray-900 dark:text-gray-100">AiGent® System Development</div>
                    <div className="text-gray-600 dark:text-gray-400">
              ...
              <div className="relative pl-8 sm:pl-32 py-6 group">
                <div className="flex flex-col sm:flex-row items-start mb-1 group-last:before:hidden before:absolute before:left-2 sm:before:left-12 before:h-full before:px-px before:bg-gray-300 dark:before:bg-gray-600 before:ml-0.5 before:top-6 before:bottom-0">
                  ...
                  <div className="font-caveat font-bold text-xl text-[#0076FF] dark:text-blue-400 w-24 hidden sm:block">$50,000</div>
                  <div>
                    <div className="sm:hidden font-caveat font-bold text-xl text-[#0076FF] dark:text-blue-400 mb-1">$50,000</div>
                    <div className="text-xl font-bold text-gray-900 dark:text-gray-100">AiPex Platform</div>
                    <div className="text-gray-600 dark:text-gray-400">
              ...
              <div className="relative pl-8 sm:pl-32 py-6 group">
                <div className="flex flex-col sm:flex-row items-start mb-1 group-last:before:hidden before:absolute before:left-2 sm:before:left-12 before:h-full before:px-px before:bg-gray-300 dark:before:bg-gray-600 before:ml-0.5 before:top-6 before:bottom-0">
                  ...
                  <div className="font-caveat font-bold text-xl text-[#0076FF] dark:text-blue-400 w-24 hidden sm:block">$100,000</div>
                  <div>
                    <div className="sm:hidden font-caveat font-bold text-xl text-[#0076FF] dark:text-blue-400 mb-1">$100,000</div>
                    <div className="text-xl font-bold text-gray-900 dark:text-gray-100">Market Launch</div>
                    <div className="text-gray-600 dark:text-gray-400">
      ...
      {/* Donation Tiers */}
      <section id="tiers" className="py-16 bg-white dark:bg-gray-950">
        <div className="container px-4 md:px-6 mx-auto">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-[#1A365D] dark:text-blue-300 mb-4">Support Levels</h2>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {donationTiers.map((tier) => (
                <Card key={tier.name} className="flex flex-col border-2 hover:border-[#0076FF] dark:border-gray-700 dark:hover:border-blue-600 transition-all">
                  <CardContent className="flex flex-col flex-grow p-6">
                    <div className="mb-4">
                      <span className="inline-block bg-[#0076FF]/10 dark:bg-blue-900/30 text-[#0076FF] dark:text-blue-400 px-3 py-1 rounded-full text-sm font-medium">
                        {tier.name}
                      </span>
                    </div>
                    <div className="mb-6">
                      <span className="text-3xl font-bold text-[#1A365D] dark:text-blue-300">${tier.amount}</span>
                    </div>
                    <p className="text-gray-600 dark:text-gray-300 mb-6">{tier.description}</p>
                    <div className="mb-6 flex-grow">
                      <h4 className="font-medium text-[#1A365D] dark:text-blue-300 mb-2">What's included:</h4>
                      <ul className="space-y-2">
                        {tier.perks.map((perk, i) => (
                          <li key={i} className="flex items-start">
                            <ChevronRight className="h-5 w-5 text-[#0076FF] dark:text-blue-400 flex-shrink-0 mt-0.5" />
      ...
      <section className="py-16 bg-gray-50 dark:bg-gray-900">
        <div className="container px-4 md:px-6 mx-auto">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-[#1A365D] dark:text-blue-300 mb-4">Project Timeline</h2>
              <p className="text-gray-600 dark:text-gray-400">Our roadmap for bringing these AI solutions to life</p>
            </div>
                  ...
                  <div className="flex flex-col items-center mr-4">
                    <div
                      className={`rounded-full h-8 w-8 flex items-center justify-center ${
                        milestone.completed ? "bg-[#0076FF]" : "bg-gray-300 dark:bg-gray-600"
                      } text-white`}
                    >
                      {milestone.completed ? <Check className="h-4 w-4" /> : index + 1}
                    </div>
                    {index < milestones.length - 1 && (
                      <div className={`w-0.5 h-full ${milestone.completed ? "bg-[#0076FF]" : "bg-gray-300 dark:bg-gray-600"}`}></div>
                    )}
                  </div>
                  <div className="pb-8">
                    <div className="flex items-baseline mb-1">
                      <h3 className="text-lg font-bold text-[#1A365D] dark:text-blue-300">{milestone.title}</h3>
                      <span className="ml-3 text-sm text-gray-500 dark:text-gray-400">{milestone.date}</span>
                    </div>
      ...
      <section className="py-16 bg-white dark:bg-gray-950">
        <div className="container px-4 md:px-6 mx-auto">
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-[#1A365D] dark:text-blue-300 mb-4">Frequently Asked Questions</h2>
            </div>

            <div className="space-y-6">
              <div>
                <h3 className="text-xl font-bold text-[#1A365D] dark:text-blue-300 mb-2">What is the AiGent® System?</h3>
              ...
              <div>
                <h3 className="text-xl font-bold text-[#1A365D] dark:text-blue-300 mb-2">What is AiPex?</h3>
                <p className="text-gray-600 dark:text-gray-300">
              ...
              <div>
                <h3 className="text-xl font-bold text-[#1A365D] dark:text-blue-300 mb-2">When will these products launch?</h3>
                <p className="text-gray-600 dark:text-gray-300">
              ...
              <div>
                <h3 className="text-xl font-bold text-[#1A365D] dark:text-blue-300 mb-2">
